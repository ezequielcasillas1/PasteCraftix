export const AI_SELECTORS = {
  ...
  modelInfoModal: 'aiModelInfoModal',
  modelInfoTitle: 'aiModelInfoTitle',
  modelInfoTagline: 'aiModelInfoTagline',
  modelInfoCost: 'aiModelInfoCost',
  modelInfoDescription: 'aiModelInfoDescription',
  modelInfoClose: 'closeAiModelInfo',
  modelInfoDone: 'aiModelInfoDone',
