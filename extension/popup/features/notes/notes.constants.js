...
export const NOTES_SELECTORS = Object.freeze({
  ...
  CLIP_PICKER_WRITE_TAB: 'clipPickerWriteTab',
  CLIP_PICKER_PDF_TAB: 'clipPickerPdfTab',
  CLIP_PICKER_WRITE_TEXTAREA: 'clipPickerWriteTextarea',
  CLIP_PICKER_WRITE_CATEGORY: 'clipPickerWriteCategory',
  CLIP_PICKER_WRITE_MARKUP: 'clipPickerWriteMarkup',
  CLIP_PICKER_WRITE_SAVE_BTN: 'clipPickerWriteSaveBtn',
  CLIP_PICKER_WRITE_SAVE_SPINNER: 'clipPickerWriteSaveSpinner',
  CLIP_PICKER_WRITE_SAVE_LABEL: 'clipPickerWriteSaveLabel',
  CLIP_PICKER_WRITE_CLEAR_BTN: 'clipPickerWriteClearBtn',
  CLIP_PICKER_PDF_FILE_INPUT: 'clipPickerPdfFileInput',
  CLIP_PICKER_PDF_CHOOSE_BTN: 'clipPickerPdfChooseBtn',
  CLIP_PICKER_SELECT_FOOTER: 'clipPickerSelectFooter',
  // Image picker
