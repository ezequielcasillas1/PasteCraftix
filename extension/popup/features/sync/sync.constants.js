export function getDemoCategories(now = Date.now()) {
  return [
    ...
    { id: now - 700000, name: 'Links & URLs', icon: 'URL', createdAt: now - 700000, updatedAt: now - 700000 },
    { id: now - 600000, name: 'Email Templates', icon: '@', createdAt: now - 600000, updatedAt: now - 600000 },
    { id: now - 500000, name: 'AI Prompts', icon: 'AI', createdAt: now - 500000, updatedAt: now - 500000 },
    { id: now - 400000, name: 'Quick Reference', icon: 'Ref', createdAt: now - 400000, updatedAt: now - 400000 },
    { id: now - 300000, name: 'Math & Formulas', icon: 'f(x)', createdAt: now - 300000, updatedAt: now - 300000 },
    { id: now - 200000, name: 'Diagrams & Charts', icon: 'Fig', createdAt: now - 200000, updatedAt: now - 200000 },
    { id: now - 100000, name: 'Notes & Docs', icon: 'Doc', createdAt: now - 100000, updatedAt: now - 100000 }
  ];
}
