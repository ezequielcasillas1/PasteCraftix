/**
 * Canonical TieredStorage (hot/cold lazy loading).
 * Legacy entry: extension/tiered-storage.js
 * Slice ACL: extension/bridges/storage/tiered-storage.facade.js
 *
 * Handles keeping recent data locally (hot) and lazy loading older
 * data from Supabase (cold) on demand.
 */
(function initPasteCraftTieredStorage(globalScope) {
  if (globalScope.tieredStorageManager) return;
...
globalScope.TieredStorage = TieredStorage;
globalScope.TieredStorageManager = TieredStorageManager;
globalScope.tieredStorageManager = tieredStorageManager;
