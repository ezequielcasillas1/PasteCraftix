...
**Priority:** High  
**Status:** Phase 1 ✅; Phase 2 ✅; Phase 3 mostly done (3G: Notes view toggle, Widgets cards, Activity filters, sign-out/exit chrome); Settings/Profile/Modals polish + Phase 4 content widget remaining  
